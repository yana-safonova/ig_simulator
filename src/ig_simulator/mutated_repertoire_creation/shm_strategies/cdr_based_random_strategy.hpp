...
class CDRBasedRandomSHMStrategy {
    ...
    size_t GetRandomMutationNumber() {
        return RandomInt(max_mutation_number_);
    }
    ...
    SHM CreateMutationInFR(IgVariableRegionPtr ig_variable_region_ptr) {
        // todo implement me
        return SHM(0, SubstitutionSHM);
    }

public:
    CDRBasedRandomSHMStrategy(size_t max_mutation_number, double fr_mutation_prop = .25) :
    ...
    SHMSettings CreateSHM(IgVariableRegionPtr ig_variable_region_ptr) {
        ...
        cout << "# generated CDR based mutations: " << num_mutations << endl;
    }
};